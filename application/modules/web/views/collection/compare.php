                                            ...
                                            <tr>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="product-details.html" class="image">
                                                        <img class="img-fluid" src="<?php echo base_url()?>/assets/img/product/product-1.jpg" alt="Compare Product">
                                                    </a>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="product-details.html" class="image">
                                                        <img class="img-fluid" src="<?php echo base_url()?>/assets/img/product/product-2.jpg" alt="Compare Product">
                                                    </a>
                                                ...
                                                <td class="product-image-title">
                                                    <a href="product-details.html" class="image">
                                                        <img class="img-fluid" src="<?php echo base_url()?>/assets/img/product/product-3.jpg" alt="Compare Product">
                                                    </a>
