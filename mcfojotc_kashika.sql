...
--
-- Host: localhost:3306
-- Generation Time: Jun 23, 2020 at 05:20 PM
...
(49, NULL, 'banarasi dupatta', '<p><span xss=removed>very stylist and beautiful duptta</span><br></p>', 500, 's-l400.jpg', 10, 1, 'option3', 'On_Sell', '2020-06-18 09:07:49', NULL),
(50, NULL, 'banarasi saree', '<p>dgff</p>', 2500, 'dulhan-saree-500x5001.jpg', 10, 1, 'option3', 'On_Sell', '2020-06-18 09:13:17', NULL);
...
--
ALTER TABLE `product_attributes`
  MODIFY `product_attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=111;
